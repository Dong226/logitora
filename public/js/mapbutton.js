$(document).ready(function() {
    ...
    $('.map_area input').click(function() {
        ...
        if ($('.box_left').css('background-color') === 'rgb(238, 255, 255)') {
            ...
            if (wkvalue.match(inputValue)) {
                if (divname === 'pref') {
                    $(cname).append('<input type="reset" id="' + idname + '" class = "btn btn-danger mb-3 mr-3" value="' + inputValue + '">');
                } else {
                    $(cname).append('<input type="reset" id="' + idname + '" class = "btn btn-info mb-3 mr-3" value="' + inputValue + '">');
                }
            } else {
