...
<div class="kt-portlet kt-portlet--height-fluid kt-current_info mr-4">
    @include('includes.info')
        ...
        <div class="kt-portlet__body">
            <div class="kt-widget5__content">
                <div class="row">
                    ...
                    <div class="col-4 text-center"><h2 class="kt-widget5__normal text-dark"><img src="{{asset('media/img/box-1.png')}}" class="mr-3">荷物情報検索
                        </h2>
                    </div>
                </div>
            </div>
        ...
        <div class="kt-portlet__body bg-grey text-dark">
            <div class="kt-form">
                <div class="kt-portlet__body">
                    <form class="kt-form form_style" action="/luggage_search" method="post">
                        {{ csrf_field() }}
                        ...
                        <div class="kt-portlet__content text-dark">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 mt-1">
                                    <div class="kt-radio-inline">
                                        ...
                                        <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                                            <input type="radio" name="vehicle_inf" value="small">軽
                                            <span class="bg-white border-dark"></span>
                                        </label>
                                        <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                                            <input type="radio" name="vehicle_inf" value="trailer">トレーラー
                                            <span class="bg-white border-dark"></span>
                                        </label>
                                    </div>
                                </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-10 mt-1">
                                    <div class="kt-radio-inline">
                                        <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                                            <input type="radio" checked="checked" name="type" value="ウイング">ウイング
                                            <span class="bg-white border-dark"></span>
                                        </label>
                                        <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <div class="kt-radio-inline">
                                            ...
                                            <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                                                <input type="radio" checked="checked" name="spec_cond1" value="中低床">中低床
                                                <span class="bg-white border-dark"></span>
                                            </label>
                                            <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-10">
                                        <div class="kt-checkbox-inline">
                                            <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                                                <input type="radio" checked="checked" name="spec_cond2" value="総輪エアサス">総輪エアサス
                                                <span class="bg-white border-dark"></span>
                                            </label>
                                            <label class="kt-checkbox kt-checkbox--brand kt-font-lg">
                            ...
                            <div class="form-group row mb-5 mt-5">
                                <button type ="submit" class="btn btn-primary first_time_btn custom-btn" style="width: 300px; height: 80px; border-radius: 10px 10px">検 &nbsp 索</button>
                            </div>
                            <!--end::Form-->
                        </div>
                    </form>
