                ...
                <div class="kt-portlet__body kt-portlet__body--fit">
                    <div class="row">
                        <table class="table table-bordered ">
                            <thead >
                                <tr>
                                    <th class = "number">問合番号</th>
                                    <th class = "shipper">荷主<br>会社</th>
                                    <th>担当</th>
                                    <th class = "tel">TEL</th>
                                    <th>積込日時</th>
                                    <th class = "loding-space">積地</th>
                                    <th>荷降日時</th>
                                    <th class = "loding-space">降地</th>
                    ...
                    <nav aria-label="Page navigation example">
                        <ul class="pagination yellow pagination-lg justify-content-center mt-3">
                            <li class="page-item">
                            <a class="page-link" href="#" aria-label="Previous" style = "border-radius:50%;background-color:#fff">
                            <i style='font-size:12px; color:#ff6600' class='fas' >&#xf0d9;</i>
                            </a>
                            </li>
