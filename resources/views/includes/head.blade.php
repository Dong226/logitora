        ...
        <link href="{{asset('css/style_logged-page01.css')}}" rel="stylesheet" type="text/css" /> 
        <link href="{{asset('/css/style_member-edit.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('/css/style_notice.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('/css/style_emptruck_edit.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('css/style_luggage_edit.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('/css/style_luggage-search.css')}}" rel="stylesheet" type="text/css" />
